!(function (e, t) {
  ...
  function i(e) {
    ...
    return (s.call(e, { message: { type: 'ping' }, port: t.port2 }, [t.port2]), r);
  }
  function l(e, t) {
  ...
  class m {
    ...
    createWebSocket(e, t = [], r, a) {
      ...
      for (const e of t) if (!f(e)) throw new DOMException(`Failed to construct 'WebSocket': The subprotocol '${e}' is invalid.`);
      a = a || {};
      ...
      for (let e = 0; ; e++) {
        let t = (
            await this.worker.sendMessage(
              { type: 'fetch', fetch: { remote: c.toString(), method: a.method, headers: s, body: n || void 0 } },
              n ? [n] : []
            )
          ).fetch,
          o = new Response(y.includes(t.status) ? void 0 : t.body, { headers: new Headers(t.headers), status: t.status, statusText: t.statusText });
        ((o.rawHeaders = t.headers), (o.rawResponse = t), (o.finalURL = c.toString()));
        const i = r?.redirect || a.redirect;
        if (!b.includes(o.status)) return o;
        switch (i) {
          case 'follow': {
                  ...
                  const [a, o] = r.connect(
                    ...
                    (t) => {
                      t instanceof ArrayBuffer
                        ? s.call(e.websocket.channel, { type: 'message', args: [t] }, [t])
                        : s.call(e.websocket.channel, { type: 'message', args: [t] });
                    },
                    (t, r) => {
                      s.call(e.websocket.channel, { type: 'close', args: [t, r] });
                    },
                    (t) => {
